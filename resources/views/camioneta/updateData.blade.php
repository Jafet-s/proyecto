    ...
    <div class="container mt-5">
        ...
        <form action="{{ url('/actualizar-apiCam/' . $data['id_camioneta']) }}" method="POST">
            ...
            <div class="form-group">
                <label for="placas"><i class="bi bi-card-text"></i> Placas</label>
            ...
            <div class="form-group">
                <label for="modelo"><i class="bi bi-person"></i> Modelo</label>
                <input type="text" class="form-control" name="modelo" value="{{ $data['modelo'] }}">
            </div>

            <div class="form-group">
                <label for="capacidad"><i class="bi bi-person"></i> Capacidad</label>
                <input type="text" class="form-control" name="capacidad" value="{{ $data['capacidad'] }}">
            </div>

            <div class="form-group">
                <label for="id_garrafon"><i class="bi bi-calendar"></i> Garrafon</label>
                <input type="text" class="form-control" name="id_garrafon" value="{{ $data['id_garrafon'] }}">
            </div>

            <div class="form-group">
                <label for="id_repartidor"><i class="bi bi-calendar"></i> Repartidor</label>
                        <input type="text" class="form-control" name="id_repartidor" value="{{ old('id_repartidor') }}">
                    </div>

            <button type="submit" class="btn btn-primary">
                <i class="bi bi-save"></i> Actualizar
            </button>
            <a href="{{ url('/consultar-api') }}" class="btn btn-secondary">
