...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <table class="table table-bordered">
                    <tbody>
                        <tr>
                        <th><i class="bi bi-person-badge"></i> ID</th><td>{{ $data['id_garrafon'] }}</td></tr>
                        <tr><th><i class="bi bi-card-text"></i> Estado</th><td>{{ $data['estado'] }}</td></tr>
                        <tr><th><i class="bi bi-person"></i> Peso</th><td>{{ $data['peso'] }}</td></tr>
        ...
        <a href="{{ url('/consultar-apiGar') }}" class="btn btn-secondary mt-3">
