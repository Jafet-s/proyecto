...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="{{ url('/actualizar-apiCli/' . $data['id_cliente']) }}" method="POST">
            @csrf
            ...
            <div class="form-group">
                <label for="correo"><i class="bi bi-calendar"></i> Email</label>
                <input type="text" class="form-control" name="correo" value="{{ $data['correo'] }}">
            </div>

            <div class="form-group">
                <label for="contraseña"><i class="bi bi-calendar"></i> Password</label>
                        <input type="pasword" class="form-control" name="contraseña" value="{{ old('contraseña') }}">
                    </div>

            <button type="submit" class="btn btn-primary">
                <i class="bi bi-save"></i> Actualizar
            </button>
            <a href="{{ url('/consultar-apiCli') }}" class="btn btn-secondary">
