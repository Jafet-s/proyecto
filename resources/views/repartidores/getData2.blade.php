...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <table class="table table-bordered">
                    <tbody>
                        <tr><th><i class="bi bi-person-badge"></i> ID</th><td>{{ $data['id_repartidor'] }}</td></tr>
                        ...
                        <tr><th><i class="bi bi-person"></i> Apellido Paterno</th><td>{{ $data['App'] }}</td></tr>
                        <tr><th><i class="bi bi-person"></i> Apellido Materno</th><td>{{ $data['Apm'] }}</td></tr>
                        <tr><th><i class="bi bi-calendar"></i> Email</th><td>{{ $data['Email'] }}</td></tr>
                        <tr><th><i class="bi bi-calendar"></i> Conreaseña</th><td>{{ $data['Password'] }}</td></tr>
        ...
        <a href="{{ url('/consultar-api') }}" class="btn btn-secondary mt-3">
